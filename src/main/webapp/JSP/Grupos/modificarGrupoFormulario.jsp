        ...
        <fieldset>
            ...
            <form action="ModificarGrupo" method="post">
                ...
                <div class="form-row2">
                    ...
                    <input type="text" id="denominacion" name="denominacion" placeholder="Ej: DAW2" value="${grupo1.denominacion}"  onblur="validarDenominacion()" required>
                </div>
                <div class="form-row2">
                    <label for="tutor">Tutor</label>
                    <input type="text" id="tutor" name="tutor" placeholder="Ej: Jesús García" value="${grupo1.tutor}"  onblur="validarTutor()" required>
                </div>      
